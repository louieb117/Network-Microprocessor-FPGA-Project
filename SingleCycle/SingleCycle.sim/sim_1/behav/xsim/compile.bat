...
REM
REM Generated by Vivado on Tue Sep 27 11:45:47 -0700 2022
...
echo "xvlog --incr --relax -prj tb_data_path_vlog.prj"
call xvlog  --incr --relax -prj tb_data_path_vlog.prj -log xvlog.log
